...
{
    public abstract class LiveLifeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LiveLifeWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LiveLifeWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<LiveLifeDbContext> action)
        {
            using (var context = IocManager.Resolve<LiveLifeDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<LiveLifeDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<LiveLifeDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LiveLifeDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LiveLifeDbContext, Task<T>> func)
        {
            T result;
